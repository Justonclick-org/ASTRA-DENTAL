...
export function buildLocalBusinessSchema() {
  return {
    ...
    employee: {
      ...
      hasCredential: 'BDS (GDC Mumbai), MDS in Periodontology & Implantology (SDC, Chennai)',
      description: 'World Record Holder | Specialist in Periodontology, Implantology & Perio-plastic Surgery',
